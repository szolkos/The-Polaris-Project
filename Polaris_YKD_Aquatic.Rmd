...
# Short-term and legacy effects of fire on lake chemistry
  ...
  ## *Surface water chemistry: Year > LandscapeCategory > BurnHx* ####
    ## Subset data
    param <- "pH"
    ykd_sub2 <- droplevels(subset(ykd, select=param, ykd$LandscapeCategory=="fen" | ykd$LandscapeCategory=="stream" | ykd$LandscapeCategory=="pond" | ykd$LandscapeCategory=="lake"))
